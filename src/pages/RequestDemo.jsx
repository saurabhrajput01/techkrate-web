...
        <div className="bg-[#2563EB] py-24 px-6 text-center">
...
              className="px-8 py-3 bg-[#2563EB] text-white font-semibold rounded-full hover:bg-[#1D4ED8] transition-colors shadow-lg"
            >
              Back to Form
            </button>
          </div>
...
            See how our solutions fit your needs — tailored walkthrough, real data examples, and next-step recommendations.
          </p>
        
        </div>
      </div>
...
          <button
            type="submit"
            className="w-full py-3 bg-gradient-to-r from-[#2563EB] to-[#1D4ED8] text-white rounded-full font-semibold hover:from-[#1D4ED8] hover:to-[#2563EB] transition-colors shadow-lg"
          >
